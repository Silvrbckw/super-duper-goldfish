...
# installed.
TCL_PREFIX='/workspaces/codespaces-flask/.conda'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/workspaces/codespaces-flask/.conda'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /workspaces/codespaces-flask/.conda/include -fdebug-prefix-map=/opt/conda/conda-bld/tk_1654088763175/work=/usr/local/src/conda/tk-8.6.12 -fdebug-prefix-map=/workspaces/codespaces-flask/.conda=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /workspaces/codespaces-flask/.conda/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/workspaces/codespaces-flask/.conda/lib -Wl,-rpath-link,/workspaces/codespaces-flask/.conda/lib -L/workspaces/codespaces-flask/.conda/lib -Wl,--export-dynamic '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/workspaces/codespaces-flask/.conda/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/workspaces/codespaces-flask/.conda/include'
...
TCL_PACKAGE_PATH='{/workspaces/codespaces-flask/.conda/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/workspaces/codespaces-flask/.conda/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/opt/conda/conda-bld/tk_1654088763175/work/tcl8.6.12/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/workspaces/codespaces-flask/.conda/lib/libtclstub8.6.a'
